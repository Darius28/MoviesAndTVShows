...
import {getApiDetails, saveSelectedMovie, getSelectedMovieId} from '../redux/actions/ActionCreator'
    ...
    return (
        <div>
            ...
            <div style={{paddingLeft: '6vw'}}>
                <h5><span className='white'>Showing results for: </span>{search}</h5>
...
const mapDispatchToProps = dispatch => {
    return{
        getApiDetails: (data) => dispatch(getApiDetails(data)),
